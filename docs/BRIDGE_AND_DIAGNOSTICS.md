...
SYNCHRON-X има MCP Streamable HTTP адрес `/mcp` и 12 инструмента: 10 само за
четене, един ограничен разговор с AI CORE и един двустъпков потвърждаван
GitHub cleanup flow. Разговорният инструмент пази нишката в собствения профил,
но не стартира Capability Engine, външни действия или промени по код. Основните
read инструменти включват:

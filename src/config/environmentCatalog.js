...
export const ENVIRONMENT_CATALOG = Object.freeze(
  [
    ...
    general(
      "ANTHROPIC_MODEL",
      "AI ядро",
      "Поддържан Anthropic модел: claude-sonnet-5.",
      { hasDefault: true },
    ),
    general(
      "ANTHROPIC_API_URL",
      "AI ядро",
      "Адрес за Anthropic Messages API.",
      { hasDefault: true },
    ),
    general(
      "ANTHROPIC_API_VERSION",
      "AI ядро",
      "Версия на Anthropic API.",
      { hasDefault: true },
    ),
    general(
    ...
    general(
      "ANTHROPIC_EFFORT",
      "AI ядро",
      "Ниво на усилие за Anthropic: low, medium, high, max или xhigh.",
      { hasDefault: true },
    ),

...
export const PROJECT_BASE_CONTEXT = Object.freeze([
  ...
  "OpenAI Responses API е разговорният доставчик по подразбиране. Gemini и Grok от xAI са опционални директни адаптери, които се включват само чрез изрична конфигурация. Старият DigitalOcean Agent е премахнат и не се използва като резервен.",

...
export const PROJECT_BASE_CONTEXT = Object.freeze([
  ...
  "OpenAI Responses API е разговорният доставчик по подразбиране. Gemini, Grok от xAI и Vertex AI Gemini са опционални адаптери, които се включват само чрез изрична конфигурация.",

export const PRODUCT_NAME = "СЪЗВУК";
...
export const PROJECT_DEFINITION =
  "СЪЗВУК е лична AI операционна система, която познава човека, има постоянна контролирана памет и използва разрешени инструменти за изпълнение на реални задачи. За всяка задача тя може да избира най-подходящия AI модел, вместо да зависи от един-единствен AI. SYNCHRON-X остава техническото име на текущото ядро и домейна.";

export const AVATAR_DEFINITION =
  "AI аватарът е интерфейсът на СЪЗВУК — лицето, гласът, характерът и начинът на общуване.";

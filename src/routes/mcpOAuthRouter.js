...
function oauthError(res, error) {
  ...
  return res.status(known ? error.status : 500).json({
    ...
    error_description: known
      ? error.description
      : "SYNCHRON-X OAuth временно не е достъпен.",
  });
}

...
function publicDigitalOceanStatus(status = {}, oauth = {}) {
  ...
  return {
    ...
    oauth: {
      ...
      authorizationCallbackHost: oauth.authorizationCallbackHost || null,
      authorizationCallbackPath: oauth.authorizationCallbackPath || null,
      authorizationRedirectStatus: oauth.authorizationRedirectStatus || null,
      authorizationLocationLength: oauth.authorizationLocationLength || null,

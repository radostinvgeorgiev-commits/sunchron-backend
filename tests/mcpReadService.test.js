...
test("anonymous production status omits identifiers and configuration names", async () => {
  const handle = createMcpRequestHandler({
    ...
    getOAuthRuntimeStatus: () => ({
      ...
      authorizationCallbackHost: "chatgpt.com",
      authorizationCallbackPath: "/connector/oauth/test-callback",
      authorizationRedirectStatus: 302,
      authorizationLocationLength: 512,
